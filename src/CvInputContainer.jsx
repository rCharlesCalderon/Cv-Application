...
const [customTitle, setCustomTitle] = useState('');
    const handleExperienceInfo = () => {
     ...
     const handleExpDelete = (expObj) => {
         const deleteExp = cData.Experience.filter(
             (obj) => obj.id !== expObj.id
         );

         setCvData({ ...cData, Experience: deleteExp });
     };
     const handleEduDelete = (eduObj) => {
         const deleteExp = cData.Education.filter(
             (obj) => obj.id !== eduObj.id
         );
     ...
     const handleCustomDelete = (customObj) => {
         const deleteExp = cData.CustomSkills.filter(
             (obj) => obj.id !== customObj.id
         );
         ...
         <>
             <div className="CvInputContainer">
                 <div className="inputs">
                     ...
                     <button className="btn" onClick={handleExperienceInfo}>
                         + Add Experience{' '}
                     </button>
                     <h1>Education</h1>
                     ...
                     <button className="btn" onClick={handleEducationInfo}>
                         + Add Education
                     </button>
                     ...
                     ></textarea>
                     <button className="btn" onClick={handleCustomInfo}>
                         +Add Custom Skill
                     </button>
                 </div>
             </div>
